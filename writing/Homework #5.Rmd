...
# Plotting
```{r fig.width = 5, fig.height = 3, make the plot}
...
balt2 %>% 
  ...
  geom_vline(aes(xintercept = z), color = "#CC0000", size=2,
             linetype = "longdash", vline.data) +
  annotate("text", x = ymd("2014-03-01"), y = 43, 
           label = "          Arrest of \n Freddie Grey", 
           color = "#CCCCCC")
```
